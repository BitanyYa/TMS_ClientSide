...
export interface Student {
  ...
  gpa?: number; // Optional property (number | undefined)
}

// Type Guard: returns a boolean predicate (value is Student)
...
// Parse function: narrows and constructs or throws a specific descriptive error
export function parseStudent(raw: unknown): Student {
  ...
  return {
    ...
    ...(typeof obj.gpa === "number" ? { gpa: obj.gpa } : {})
  };
}